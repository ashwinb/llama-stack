...
class NVIDIAConfig(RemoteInferenceProviderConfig):
    ...
    base_url: HttpUrl | None = Field(  # ty: ignore[invalid-assignment]  # Pydantic coerces str from default_factory to HttpUrl
    ...
    def sample_run_config(
        cls,
        base_url: str | None = "${env.NVIDIA_BASE_URL:=https://integrate.api.nvidia.com/v1}",
