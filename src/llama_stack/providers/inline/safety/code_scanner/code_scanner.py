...
if TYPE_CHECKING:
    from codeshield.cs import CodeShieldScanResult  # ty: ignore[unresolved-import]  # optional third-party dependency
...
class BuiltinCodeScannerSafetyImpl(Safety):
    ...
    async def run_shield(self, request: RunShieldRequest) -> RunShieldResponse:
        ...
        from codeshield.cs import CodeShield  # ty: ignore[unresolved-import]  # optional third-party dependency
