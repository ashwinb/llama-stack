...
class ShieldsRoutingTable(CommonRoutingTableImpl, Shields):
    ...
    async def list_shields(self) -> ListShieldsResponse:
        return ListShieldsResponse(data=await self.get_all_with_type(ResourceType.shield.value))  # type: ignore[arg-type]  # ty: ignore[invalid-argument-type]
    ...
    async def get_shield(self, request: GetShieldRequest) -> Shield:
        ...
        return shield  # type: ignore[return-value]  # ty: ignore[invalid-return-type]
    ...
    async def unregister_shield(self, request: UnregisterShieldRequest) -> None:
        ...
        await self.unregister_object(existing_shield)  # type: ignore[arg-type]  # ty: ignore[invalid-argument-type]
