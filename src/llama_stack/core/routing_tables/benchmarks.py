...
class BenchmarksRoutingTable(CommonRoutingTableImpl, Benchmarks):
    ...
    async def list_benchmarks(self, request: ListBenchmarksRequest) -> ListBenchmarksResponse:
        return ListBenchmarksResponse(data=await self.get_all_with_type("benchmark"))  # ty: ignore[invalid-argument-type]  # concrete type accepted at runtime
    ...
    async def get_benchmark(self, request: GetBenchmarkRequest) -> Benchmark:
        ...
        return benchmark  # ty: ignore[invalid-return-type]  # returns narrower type than parent
    ...
    async def unregister_benchmark(self, request: UnregisterBenchmarkRequest) -> None:
        ...
        await self.unregister_object(existing_benchmark)  # ty: ignore[invalid-argument-type]  # unregister_object accepts RoutableObjectWithProvider
