...
class BenchmarksRoutingTable(CommonRoutingTableImpl, Benchmarks):
    ...
    async def list_benchmarks(self, request: ListBenchmarksRequest) -> ListBenchmarksResponse:
        return ListBenchmarksResponse(data=await self.get_all_with_type("benchmark"))  # type: ignore[arg-type]  # ty: ignore[invalid-argument-type]
    ...
    async def get_benchmark(self, request: GetBenchmarkRequest) -> Benchmark:
        ...
        return benchmark  # type: ignore[return-value]  # ty: ignore[invalid-return-type]
    ...
    async def unregister_benchmark(self, request: UnregisterBenchmarkRequest) -> None:
        ...
        await self.unregister_object(existing_benchmark)  # type: ignore[arg-type]  # ty: ignore[invalid-argument-type]
