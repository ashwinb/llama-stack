...
async def get_auto_router_impl(
    ...
    if api == Api.inference:
        ...
        api_to_dep_impl["inference_api"] = deps.get(Api.inference)  # ty: ignore[invalid-argument-type] - Api enum used as dict key
    elif api == Api.safety:
        api_to_dep_impl["safety_config"] = run_config.safety

    impl = api_to_routers[api.value](routing_table, **api_to_dep_impl)  # ty: ignore[invalid-argument-type] - dynamic router construction with union types
