        ...
        for name, method in protocol_methods:
            ...
            for webmethod in webmethods:
                ...
                routes.append(
                    ...
                    (Route(path=path, methods=[http_method], name=name, endpoint=None), webmethod)  # ty: ignore[invalid-argument-type]
                )
...
def initialize_route_impls(
    impls: dict[Api, Any], external_apis: dict[Api, ExternalApiSpec] | None = None
) -> RouteImpls:
