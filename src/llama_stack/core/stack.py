...
class Stack:
    ...
    async def initialize(self) -> None:
        ...
        dist_registry, _ = await create_dist_registry(stores.metadata, self.run_config.distro_name)  # ty: ignore[invalid-argument-type]
    ...
    async def shutdown(self) -> None:
        for impl in self.impls.values():  # ty: ignore[unresolved-attribute]
